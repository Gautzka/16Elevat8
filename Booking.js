...
// For the API
// 1. Have one generic function ?
// 2. Have one dedicated function that only queries or redirect / validate login

// https://crossfit168.clubfit.net.au/api/v1/booking/book-class-v2 -> dedicated Function bookClass
// https://crossfit168.clubfit.net.au/api/v1/booking/cancel/${memberBookingId}  -> dedicated Function cancelBooking
// https://admin.clubfit.net.au/api/v1/account/validate -> dedicated function validateLogin

// https://crossfit168.clubfit.net.au/api/v1/booking/search-classes -> API Function
// https://crossfit168.clubfit.net.au/api/v1/booking/current/' + userId  -> API Function


// Make sure every refresh has promise / async to wait (same as API) with retry
...
// 1. Adjust the date datePicker
// 2. Store the new datePicker local Storage
// 3. Change the header date
// 4. Check the class available and display them


// When we change location:
// 1. Check the class available and display them 


// When we change book / cancel from the "book a class"
// 1. Check the class available and display them

// When we change  cancel from the "next booking"
// 2. Check the class booked and display them

// When we load the page "next-booking":
// 1. Check the class booked and display them

// When we load the page "Book a class":
// 1. Do nothing, we show an empty page
